              ...
              {isActive && (
                <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
                  ...
                  <form onSubmit={handleLogActivity} className="space-y-3">
                    ...
                    <textarea value={activityNote} onChange={e => setActivityNote(e.target.value)} placeholder={`Add notes for this ${activityType}...`} rows={2}
            ...
            <div className="p-6 space-y-5">
              <form onSubmit={handleAddNote} className="space-y-3">
                ...
                <div className="relative">
                  ...
                  <textarea value={newNote} onChange={e => setNewNote(e.target.value)} placeholder="Write a note about this lead..." rows={3}
